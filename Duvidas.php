...
<section id="duvidas" class="duvidas section-bg">
    <div class="container">
        ...
        <div class="lista-duvidas" data-aos="fade-up" data-aos-delay="200">
            <ul>
                <li data-aos="fade-up">
                    <i class="bx bx-help-circle icon-help"></i><a data-bs-toggle="collapse" class="collapse tittle-duvidas" data-bs-target="#lista-duvidas-1">
                    ...
                    <div id="lista-duvidas-1" class="collapse show" data-bs-parent=".lista-duvidas">
                        <p class="mt-1 col-lg-8">
                            Acesse nossa <a href="https://jrnetsp.sgp.net.br/accounts/central/login">Central do Assinante</a>, faça login com <b>CPF</b> ou <b>Login/Senha</b> e retire sua Segunda Via.
                        </p>
                    </div>
                </li>
                <li data-aos="fade-up" data-aos-delay="100">
                    <i class="bx bx-help-circle icon-help"></i><a data-bs-toggle="collapse" class="collapse tittle-duvidas" data-bs-target="#lista-duvidas-2">
                    ...
                    <div id="lista-duvidas-2" class="collapse" data-bs-parent=".lista-duvidas">
                        <p class="mt-1 col-lg-8">
                            ...
                            O Cadastro pode ser feito presencialmente no momento da instalação,
                            mas caso queira agilizar faça-o em <a href="Cadastro.php">Cadastro</a>,
                            assim restará apenas agendar o dia de sua instalação.
                        </p>
                    </div>
                </li>
                <li data-aos="fade-up" data-aos-delay="200">
                    <i class="bx bx-help-circle icon-help"></i><a data-bs-toggle="collapse" class="collapse tittle-duvidas" data-bs-target="#lista-duvidas-3">
                    ...
                    <div id="lista-duvidas-3" class="collapse" data-bs-parent=".lista-duvidas">
                        <p class="mt-1 col-lg-8">
                            A Fibra Ótica é composta por uma série de tubos feitos de vidro que transportam dados através da luz, 
                            resultando em uma velocidade muito maior do que os cabos convencionais (UTP) feitos de cobre. <br><br> 
                            Quando se trata de velocidades acima de 30 Megas utilizando cabos de cobre a conexão passa a sofrer 
                            bastante oscilação e perdas, sendo aí o destaque da Fibra Ótica, que suporta velocidades altíssimas sem que 
                            haja oscilações que comprometam sua velocidade.
                        </p>
                    </div>
                </li>
                <li data-aos="fade-up" data-aos-delay="300">
                    <i class="bx bx-help-circle icon-help"></i><a data-bs-toggle="collapse" class="collapse tittle-duvidas" data-bs-target="#lista-duvidas-4">
                    ...
                    <div id="lista-duvidas-4" class="collapse" data-bs-parent=".lista-duvidas">
                        ...
                        Quando, por exemplo, você manda mensagem para um amigo no WhatsApp acaba-se utilizando a velocidade de 
                        ''Upload'', e no momento em que recebe uma mensagem você faz ''Download'' para visualiza-la. <br><br> 
                        Geralmente só é utilizado cerca de 8-12% de velocidade de Upload, portanto caso você tenha 50MBs de internet, 
                        seu download baixará numa média de 5-7Mb/s, claro que também dependerá de seu equipamento e o serviço contratado.
                        </p>
                    </div>
                </li>
            </ul>
